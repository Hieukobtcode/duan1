                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Sửa hình ảnh sản phẩm</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label">Mô tả</label>
                                        <textarea name="mo_ta" class="form-control" placeholder="Nhập mô tả"><?= $hinh_anh['mo_ta'] ?></textarea>
                                ...
                                <div class="form-group">
                                    <img width="300px" src="./assets/img/<?= $hinh_anh['img'] ?>" alt="">
